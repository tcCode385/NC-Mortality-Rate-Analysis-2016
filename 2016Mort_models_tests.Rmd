...
```{r, warning=FALSE}
spat.dat_2 <- readOGR(dsn = "/Users/tamara/Documents/DataProjects/Mortality/SpatDat_noNA", layer = "nc_mort16_spat_noNA")  ## bring in no NA spatial files

shp <- st_read("/Users/tamara/Documents/DataProjects/Mortality/SpatDat_noNA/nc_mort16_spat_noNA.shp")   ### bring in the shape file, data without NA's
